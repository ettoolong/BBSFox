    ...
    SetPageState: function() {
      ...
      if( this.IsUnicolor(0, 0, cols/2 - 11) && this.IsUnicolor(0, cols/2 + 20, cols-10) ) {
        ...
        if( this.IsUnicolor(rows-1, 28, cols-27) && this.cur_y==rows-1) {
          ...
          if(this.prefs.testPttThread && this.isPttReading() && bbsfox.CmdHandler.getAttribute('OpenThreadUrlMenu')=='1')
            threadState = 1;
        }
      }
      if(this.PageState == 0) {
      ...
      if(threadState == 1)
        bbsfox.CmdHandler.setAttribute('OpenThreadUrlMenu', '1');
      else
        bbsfox.CmdHandler.setAttribute('OpenThreadUrlMenu', '0');
    },
